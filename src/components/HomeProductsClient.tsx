        ...
        <>
            ...
            <section className="pb-10 border-t border-gray-100 pt-10">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-2">
                    ...
                    <a href="/categories/vtements-homme" className="text-[#006233] font-semibold hover:underline text-sm sm:text-base flex items-center gap-1">
                        Voir tout <span>→</span>
                    </a>
                </div>
                <ProductGrid
            ...
            <section className="pb-10 border-t border-gray-100 pt-10">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-2">
                    ...
                    <a href="/categories/vtements-femme" className="text-[#006233] font-semibold hover:underline text-sm sm:text-base flex items-center gap-1">
                        Voir tout <span>→</span>
                    </a>
                </div>
                <ProductGrid
