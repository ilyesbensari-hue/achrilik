        ...
        const init = async () => {
            try {
                ...
                try {
                    ...
                    setUser(parsedUser);
                    // Default to seller view if they are a seller
                ...
                // 1. Fetch Buyer Orders (Always useful)
                fetch(`/api/orders?userId=${parsedUser.id}`)
                    .then(res => res.json())
                    .then(data => {
                ...
                if (parsedUser.role === 'SELLER') {
                    ...
                    const myStore = stores.find((s: any) => s.ownerId === parsedUser.id);
