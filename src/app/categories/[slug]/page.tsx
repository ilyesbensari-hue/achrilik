                                        ...
                                        <div className="p-5 space-y-4">
                                            ...
                                            {availableSizes.length > 0 && (
                                                <div className="border border-gray-200 rounded-lg overflow-hidden">
                                                    ...
                                                    >
                                                        ...
                                                        <svg className={`w-5 h-5 text-gray-500 transition-transform ${expandedSection === 'size' ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                                                        </svg>
                                                    </button>
                                            ...
                                            <div className="border border-gray-200 rounded-lg overflow-hidden">
                                                ...
                                                >
                                                    ...
                                                    <svg className={`w-5 h-5 text-gray-500 transition-transform ${expandedSection === 'price' ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                                                    </svg>
                                                </button>
                                                                ...
                                                                {availableColors.map((color) => {
                                                                    ...
                                                                    return (
                                                                        <button
                                                                            ...
                                                                            title={color}
                                                                            className={`flex items-center gap-1.5 px-2.5 py-1.5 rounded-full border-2 text-xs font-semibold transition-all ${isSelected
                                            ...
                                            {availableWilayas.length > 0 && (
                                                <div className="border border-gray-200 rounded-lg overflow-hidden">
                                                    ...
                                                    >
                                                        ...
                                                        <svg className={`w-5 h-5 text-gray-500 transition-transform ${expandedSection === 'wilaya' ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                                                        </svg>
                                                    </button>
                                                    {expandedSection === 'wilaya' && (
                                                        <div className="p-4 space-y-2 max-h-60 overflow-y-auto">
                                                            <label className="flex items-center gap-3 p-2 hover:bg-gray-50 rounded-lg cursor-pointer">
                                                                <input type="radio" name="wilaya" checked={selectedWilaya === ''} onChange={() => setSelectedWilaya('')} className="w-4 h-4 text-[#006233] focus:ring-[#006233]" />
                                                                <span className={`text-sm ${selectedWilaya === '' ? 'font-medium' : 'text-gray-700'}`}>{tr('cat_page_all_wilayas')}</span>
                                                            </label>
                                                            {availableWilayas.map((wilaya) => (
                                                                <label key={wilaya as string} className="flex items-center gap-3 p-2 hover:bg-gray-50 rounded-lg cursor-pointer">
                                                                    <input type="radio" name="wilaya" checked={selectedWilaya === wilaya} onChange={() => setSelectedWilaya(wilaya as string)} className="w-4 h-4 text-[#006233] focus:ring-[#006233]" />
                                                                    <span className={`text-sm ${selectedWilaya === wilaya ? 'font-medium' : 'text-gray-700'}`}>{wilaya as string}</span>
                                                                </label>
                                                            ))}
                                                        </div>
                                                    )}
